...
The function
[`chk_requirements()`](https://richardjtelford.github.io/checker/reference/chk_requirements.md)
...
By default,
[`chk_requirements()`](https://richardjtelford.github.io/checker/reference/chk_requirements.md)
uses a yaml file included in the installation. To run
[`chk_requirements()`](https://richardjtelford.github.io/checker/reference/chk_requirements.md)
...
meet your requirements by hand or with the function
[`chk_make()`](https://richardjtelford.github.io/checker/reference/chk_make.md)
which takes data.frames of recommended programs, packages, and RStudio
options as arguments. Recommended and/or minimum version and any message
can be included in these data.frames.
